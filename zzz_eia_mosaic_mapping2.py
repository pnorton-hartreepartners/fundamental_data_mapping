...
there are three different hierarchy formats to resolve
1) leaf node only eg two:baz
2) full branch eg zero:foo@one:bar@two:baz
3) part branch eg one:bar@two:baz
this script iterates through each using a list of upload errors
